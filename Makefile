...
aif2tga:	src/aif2tga.c packer dumper loader_ace include/packer.h include/dump.h
	$(CC) $(CFLAGS) -o bin/aif2tga src/aif2tga.c build/pp20.o build/rle.o build/dump_tga.o build/loader_aif.o
