...
static void (*g_use_item_handlers[14])(void) = {
	NULL,                               // USABLE_ITEM_NONE                  ==  0
	item_invoke_arcano_psychostabilils, // USABLE_ITEM_ARCANO_PSYCHOSTABILIS ==  1
	item_read_recipe,                   // USABLE_ITEM_RECIPE                ==  2
	item_read_document,                 // USABLE_ITEM_DOCUMENT              ==  3
	item_invoke_armatrutz,              // USABLE_ITEM_ARMATRUTZ             ==  4
	item_invoke_flim_flam,              // USABLE_ITEM_FLIM_FLAM             ==  5
	item_read_schuldbuch,               // USABLE_ITEM_SCHULDBUCH            ==  6
	item_read_orkdokument,              // USABLE_ITEM_ORKDOKUMENT           ==  7
	item_apply_weapon_poison,           // USABLE_ITEM_WEAPON_POISON         ==  8
	item_use_miasthmaticum,             // USABLE_ITEM_MIASTHMATICUM         ==  9
	item_use_hylailer_feuer,            // USABLE_ITEM_HYLAILER_FEUER        == 10
	item_read_spellbook_heptagon,       // USABLE_ITEM_SPELLBOOK_HEPTAGON    == 11
	item_ignite,                        // USABLE_ITEM_LIGHTING              == 12
	item_use_beutel                     // USABLE_ITEM_MAGISCHER_BEUTEL      == 13
}; // ds:0xaeb0
