			...
			signed short mode)
{
	...
	if (mode == 1) {
		...
		if ( ( (target > 0) && (target < 10) &&	!hero_dead((Bit8u*)get_hero(target - 1)) && !hero_unconscious((Bit8u*)get_hero(target - 1))) || (
				...
				signed short dir, signed short renegade)
{
	...
	while (done == 0) {
		...
		if (renegade == 1) {
			...
			if ( ((obj_id > 0) && (obj_id < 10) && !hero_dead((Bit8u*)get_hero(obj_id - 1)) && !hero_unconscious((Bit8u*)get_hero(obj_id - 1))) ||
			...
			if ((obj_id >= 10) && (obj_id < 30) && !g_enemy_sheets[obj_id - 10].flags.dead)
			{
				will_attack = 1;
					 ...
					 (
						...
						(obj_id > 0) &&
#endif
						 (((obj_id < 10) && !hero_dead((Bit8u*)get_hero(obj_id - 1)) &&	!hero_unconscious((Bit8u*)get_hero(obj_id - 1))
						) || (
							(obj_id >= 50) &&
