...
void npc_harika(void)
{
	...
	if (answer == 1) {
		GUI_dialogbox((char*)ds_readd(DTP2), get_ttx(754),
			get_tx(14), 0);
	} else if (answer == 2) {
...
void npc_curian(void)
{
	...
	if (answer == 1) {
		GUI_dialogbox((char*)ds_readd(DTP2), get_ttx(755),
			get_tx(24), 0);
	} else {
		do {
			answer = GUI_dialogbox((char*)ds_readd(DTP2),
...
void npc_ardora(void)
{
	...
	if (answer == 1) {
		...
		if (answer == 2) {
			GUI_dialogbox((char*)ds_readd(DTP2), get_ttx(756),
				get_tx(37), 0);
		} else {
			do {
				answer = GUI_dialogbox((char*)ds_readd(DTP2),
		...
		do {
			answer = GUI_dialogbox((char*)ds_readd(DTP2), get_ttx(756),
					get_tx(39), 2,
					get_tx(40), get_tx(41));
		} while (answer == -1);
...
void npc_garsvik(void)
{
	...
	if (answer == 1) {
		GUI_dialogbox((char*)ds_readd(DTP2), get_ttx(757),
			get_tx(48), 0);
	} else {
		do {
			answer = GUI_dialogbox((char*)ds_readd(DTP2),
...
void npc_erwo(void)
{
	...
	if (answer == 1) {
		GUI_dialogbox((char*)ds_readd(DTP2), get_ttx(758),
			get_tx(58), 0);
	} else {
		do {
			answer = GUI_dialogbox((char*)ds_readd(DTP2),
		...
		signed short index, Bit8u* name, Bit8u *text)
{
	...
	if (text) {
		if (check_hero(get_hero(6)) != 0) {
			...
			GUI_dialogbox((char*)ds_readd(DTP2), name, text, 0);
		}
	}
