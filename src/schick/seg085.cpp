...
signed short DNG10_handler(void)
{
	...
	} else if (target_pos == DNG_POS(2,12,12) && target_pos != ds_readws(DNG_HANDLED_POS))
	{
		...
		if (!ds_readb(DNG10_DRAGON_QUEST))
		{
			...
			do {
				answer = GUI_dialogbox((unsigned char*)ds_readd(DTP2), get_tx(28),
						get_tx(29), 2,
						get_tx(30), get_tx(31));
			} while (answer == -1);
			...
			if (answer == 1)
			{
				...
				if (GUI_dialogbox((unsigned char*)ds_readd(DTP2), get_tx(28),
						get_tx(32), 2,
						get_ttx(2), get_ttx(3)) == 1)
				{
					GUI_dialogbox((unsigned char*)ds_readd(DTP2), get_tx(28), get_tx(33), 0);
				} else {
					GUI_dialogbox((unsigned char*)ds_readd(DTP2), get_tx(28), get_tx(34), 0);
				...
				if (result == 0 && !ds_readb(DNG10_HOARD_PLUNDERED))
				{
					...
					GUI_dialogbox((unsigned char*)ds_readd(DTP2), get_tx(28), get_tx(35), 0);
					...
					if (GUI_dialogbox((unsigned char*)ds_readd(DTP2), get_tx(28), get_tx(32), 2,
								get_ttx(2), get_ttx(3)) == 1)
					{
						GUI_dialogbox((unsigned char*)ds_readd(DTP2), get_tx(28), get_tx(33), 0);
					} else {
			...
			if ((answer = get_first_hero_with_item(ITEM_KEY_PLATIN)) != -1)
			{
				...
				GUI_dialogbox((unsigned char*)ds_readd(DTP2), get_tx(28), get_tx(36), 0);
				GUI_dialogbox((unsigned char*)ds_readd(DTP2), get_tx(28), get_tx(37), 0);
				...
				GUI_dialogbox((unsigned char*)ds_readd(DTP2), get_tx(28), get_tx(38), 0);
			}
		}
...
void DNG10_chest0_x2(RealPt chest)
{
	...
	host_writed((Bit8u*)(chest) + 11, (Bit32u)RealMake(datseg, DNG10_CHEST0_CONTENT));
...
{
	RealPt ptr_bak = (RealPt)host_readd((Bit8u*)(chest) + 11);
	host_writed((Bit8u*)(chest) + 11, (Bit32u)RealMake(datseg, DNG10_CHEST1_CONTENT));
...
{
	RealPt ptr_bak = (RealPt)host_readd((Bit8u*)(chest) + 11);
	host_writed((Bit8u*)(chest) + 11, (Bit32u)RealMake(datseg, DNG10_CHEST2_CONTENT));
	loot_simple_chest((Bit8u*)(chest));
	host_writed((Bit8u*)(chest) + 11, (Bit32u)ptr_bak);
}
...
{
	RealPt ptr_bak = (RealPt)host_readd((Bit8u*)(chest) + 11);
	host_writed((Bit8u*)(chest) + 11, (Bit32u)RealMake(datseg, DNG10_CHEST3_CONTENT));
	loot_simple_chest((Bit8u*)(chest));
	host_writed((Bit8u*)(chest) + 11, (Bit32u)ptr_bak);
}
...
{
	RealPt ptr_bak = (RealPt)host_readd((Bit8u*)(chest) + 11);
	host_writed((Bit8u*)(chest) + 11, (Bit32u)RealMake(datseg, DNG10_CHEST4_CONTENT));
	loot_simple_chest((Bit8u*)(chest));
	host_writed((Bit8u*)(chest) + 11, (Bit32u)ptr_bak);
}
