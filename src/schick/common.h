...
enum {
	ITEM_ID_NONE                              = 0x00, /* nothing / Bloße Hand (bare hand) */
	ITEM_ID_SCHWERT                           = 0x01, /* sword */
	ITEM_ID_KNUEPPEL                          = 0x02, /* club */
	ITEM_ID_SAEBEL                            = 0x03, /* saber */
	ITEM_ID_MESSER                            = 0x04, /* knife */
	ITEM_ID_SPEER                             = 0x05, /* spear */
	ITEM_ID_KURZSCHWERT                       = 0x06, /* short sword */
	ITEM_ID_SCHILD                            = 0x07, /* shield */
	ITEM_ID_KRIEGSBEIL__SPECIAL               = 0x08, /* hatchet [special "Schicksalsklinge" variant, also for witches, druids and mages, 1D6 + 4, KK+14, BF 5, AT-0, PA-3, weight 120, price 45] */
	ITEM_ID_KURZBOGEN                         = 0x09, /* shortbow */
	ITEM_ID_PFEIL                             = 0x0a, /* arrow */
	ITEM_ID_STREITAXT                         = 0x0b, /* battleaxe */
	ITEM_ID_ARMBRUST                          = 0x0c, /* crossbow */
	ITEM_ID_BOLZEN                            = 0x0d, /* bolt */
	ITEM_ID_DOLCH                             = 0x0e, /* dagger */
	ITEM_ID_IRON_SHIELD                       = 0x0f, /* iron shield */
	ITEM_ID_WURFBEIL                          = 0x10, /* francesca */
	ITEM_ID_WURFSTERN                         = 0x11, /* throwing star */
	ITEM_ID_ZWEIHAENDER                       = 0x12, /* two-handed sword */
	ITEM_ID_LANGBOGEN                         = 0x13, /* longbow */
	ITEM_ID_MORGENSTERN                       = 0x14, /* morning star */
	ITEM_ID_VULKANGLASDOLCH                   = 0x15, /* volcanic glass dagger */
	ITEM_ID_FACKEL__LIT                       = 0x16, /* torch [lit] */
	ITEM_ID_BIER                              = 0x17, /* beer */
	ITEM_ID_WURFHAKEN                         = 0x18, /* grapple */
	ITEM_ID_LATERNE__UNLIT                    = 0x19, /* lantern [unlit] */
	ITEM_ID_BRECHEISEN                        = 0x1a, /* crowbar */
	ITEM_ID_HAMMER                            = 0x1b, /* hammer */
	ITEM_ID_ANGELHAKEN                        = 0x1c, /* fishhook */
	ITEM_ID_SCHRIFTROLLE                      = 0x1d, /* scroll */
	ITEM_ID_WASSERSCHLAUCH                    = 0x1e, /* waterskin */
	ITEM_ID_GLASFLASCHE                       = 0x1f, /* flask glass */
	ITEM_ID_STRICKLEITER                      = 0x20, /* rope ladder */
	ITEM_ID_WURFAXT                           = 0x21, /* throwing axe */
	ITEM_ID_MESSINGSPIEGEL                    = 0x22, /* brass mirror */
	ITEM_ID_DIETRICHE                         = 0x23, /* picklocks */
	ITEM_ID_SCHREIBZEUG                       = 0x24, /* writing material */
	ITEM_ID_HARFE                             = 0x25, /* harp */
	ITEM_ID_TRINKHORN                         = 0x26, /* drinking horn */
	ITEM_ID_SILBERSCHMUCK                     = 0x27, /* silver jewelry */
	ITEM_ID_KLETTERHAKEN                      = 0x28, /* climbing hooks */
	ITEM_ID_OEL                               = 0x29, /* oil */
	ITEM_ID_BRONZEFLASCHE                     = 0x2a, /* flask bronze */
	ITEM_ID_EISENHELM                         = 0x2b, /* iron helmet */
	ITEM_ID_PIKE                              = 0x2c, /* pike */
	ITEM_ID_PROVIANTPAKET                     = 0x2d, /* food package */
	ITEM_ID_FLOETE                            = 0x2e, /* flute */
	ITEM_ID_ALCHIMIESET                       = 0x2f, /* alchemy kit */
	ITEM_ID_HEMD                              = 0x30, /* shirt */
	ITEM_ID_HOSE                              = 0x31, /* trousers */
	ITEM_ID_SCHUHE                            = 0x32, /* shoes */
	ITEM_ID_STIEFEL                           = 0x33, /* boots */
	ITEM_ID_SCHNEESCHUHE                      = 0x34, /* laceup shoe */
	ITEM_ID_LEDERHARNISCH                     = 0x35, /* leather armor */
	ITEM_ID_SCHUPPENRUESTUNG                  = 0x36, /* scale armor */
	ITEM_ID_SHURINKNOLLEKNOLLENGIFT           = 0x37, /* Shurin poison */
	ITEM_ID_ARAXGIFT                          = 0x38, /* Arax poison */
	ITEM_ID_ANGSTGIFT                         = 0x39, /* angst gift */
	ITEM_ID_SCHLAFGIFT                        = 0x3a, /* sleep poison */
	ITEM_ID_GOLDLEIM                          = 0x3b, /* Goldleim */
	ITEM_ID_EINBEERE                          = 0x3c, /* Einbeere */
	ITEM_ID_WIRSELKRAUT                       = 0x3d, /* whirlweed */
	ITEM_ID_EITRIGER_KROETENSCHEMEL           = 0x3e, /* Eitriger Krötenschemel */
	ITEM_ID_GULMOND_BLATT                     = 0x3f, /* Gulmond leaf */
	ITEM_ID_TARNELE                           = 0x40, /* Tarnele */
	ITEM_ID_FACKEL__UNLIT                     = 0x41, /* torch [unlit] */
	ITEM_ID_STREITKOLBEN                      = 0x42, /* mace */
	ITEM_ID_DEGEN                             = 0x43, /* epee */
	ITEM_ID_FLORETT                           = 0x44, /* floret */
	ITEM_ID_KAMPFSTAB                         = 0x45, /* quarterstaff */
	ITEM_ID_KRISTALLKUGEL                     = 0x46, /* crystal ball */
	ITEM_ID_PEITSCHE                          = 0x47, /* whip */
	ITEM_ID_DECKE                             = 0x48, /* blanket */
	ITEM_ID_SCHAUFEL                          = 0x49, /* shovel */
	ITEM_ID_GOLDSCHMUCK                       = 0x4a, /* gold jewelry */
	ITEM_ID_ROBE__GREEN_1                     = 0x4b, /* robe [green, cheap] */
	ITEM_ID_ROBE__RED                         = 0x4c, /* robe [red, expensive] */
	ITEM_ID_TOPFHELM                          = 0x4d, /* pot helmet */
	ITEM_ID_LEDERHELM                         = 0x4e, /* leather helmet */
	ITEM_ID_WAFFENROCK                        = 0x4f, /* surcoat */
	ITEM_ID_KETTENHEMD                        = 0x50, /* chain mail */
	ITEM_ID_KROETENHAUT                       = 0x51, /* toad skin */
	ITEM_ID_PLATTENZEUG                       = 0x52, /* plate gear */
	ITEM_ID_KETTENZEUG                        = 0x53, /* chain gear */
	ITEM_ID_LEDERZEUG                         = 0x54, /* leather gear */
	ITEM_ID_ZUNDERKAESTCHEN                   = 0x55, /* tinderbox */
	ITEM_ID_SCHLEIFSTEIN                      = 0x56, /* grindstone */
	ITEM_ID_ESSBESTECK                        = 0x57, /* cutlery */
	ITEM_ID_ESSGESCHIRR                       = 0x58, /* dishes */
	ITEM_ID_LAKRITZE                          = 0x59, /* licorice */
	ITEM_ID_BONBONS                           = 0x5a, /* bonbons */
	ITEM_ID_WEINFLASCHE                       = 0x5b, /* wine */
	ITEM_ID_SCHNAPSFLASCHE                    = 0x5c, /* brandy */
	ITEM_ID_HACKE                             = 0x5d, /* pickaxe */
	ITEM_ID_PRAIOS_AMULETT                    = 0x5e, /* Praios amulet [magic; found in Spinnenhoehle] */
	ITEM_ID_LAUTE                             = 0x5f, /* lute */
	ITEM_ID_WINTERMANTEL                      = 0x60, /* winter coat */
	ITEM_ID_NETZ                              = 0x61, /* net */
	ITEM_ID_WURFMESSER                        = 0x62, /* throwing knife */
	ITEM_ID_SICHEL                            = 0x63, /* sickle */
	ITEM_ID_SENSE                             = 0x64, /* scythe */
	ITEM_ID_KRIEGSHAMMER                      = 0x65, /* war hammer */
	ITEM_ID_DREIZACK                          = 0x66, /* trident */
	ITEM_ID_HELLEBARDE                        = 0x67, /* halberd */
	ITEM_ID_DRESCHFLEGEL                      = 0x68, /* flail */
	ITEM_ID_ZWEILILIEN                        = 0x69, /* Zweililien */
	ITEM_ID_OCHSENHERDE                       = 0x6a, /* oxen herd */
	ITEM_ID_BASILISKENZUNGE                   = 0x6b, /* basilisk tongue */
	ITEM_ID_OGERFAENGER                       = 0x6c, /* ogre catcher */
	ITEM_ID_MENGBILAR                         = 0x6d, /* Mengbilar */
	ITEM_ID_SCHWERER_DOLCH                    = 0x6e, /* heavy dagger */
	ITEM_ID_RONDRAKAMM                        = 0x6f, /* Rondra comb */
	ITEM_ID_ENTERMESSER                       = 0x70, /* cutlass */
	ITEM_ID_BASTARDSCHWERT                    = 0x71, /* bastard sword */
	ITEM_ID_TUZAKMESSER                       = 0x72, /* Tuzak knife */
	ITEM_ID_RABENSCHNABEL                     = 0x73, /* raven's beak */
	ITEM_ID_BRABAKBENGEL                      = 0x74, /* Brabakbengel */
	ITEM_ID_RAPIER                            = 0x75, /* rapier */
	ITEM_ID_KHUNCHOMER                        = 0x76, /* Khunchomer */
	ITEM_ID_DOPPELKHUNCHOMER                  = 0x77, /* double Khunchomer */
	ITEM_ID_SCHLEUDER                         = 0x78, /* sling */
	ITEM_ID_SEIL                              = 0x79, /* rope */
	ITEM_ID_SHURINKNOLLE                      = 0x7a, /* Shurink bulb */
	ITEM_ID_BELMART_BLATT                     = 0x7b, /* Belmart leaf */
	ITEM_ID_DONFSTENGEL                       = 0x7c, /* Donf spring */
	ITEM_ID_MENCHALKAKTUS                     = 0x7d, /* Menchal cactus */
	ITEM_ID_ALRAUNE                           = 0x7e, /* mandrake */
	ITEM_ID_ATMONBLUETE                       = 0x7f, /* Atmon bloom */
	ITEM_ID_ILMENBLATT                        = 0x80, /* Ilmen leaf */
	ITEM_ID_FINAGEBAEMCHEN                    = 0x81, /* Finage tree */
	ITEM_ID_JORUGAWURZEL                      = 0x82, /* Joruga root */
	ITEM_ID_THONNYSBLUETE                     = 0x83, /* Thonnys bloom */
	ITEM_ID_LOTUSBLUETE                       = 0x84, /* Lotus bloom */
	ITEM_ID_ZAUBERSTAB                        = 0x85, /* magic wand */
	ITEM_ID_SKRAJA                            = 0x86, /* Skraja */
	ITEM_ID_KRIEGSBEIL                        = 0x87, /* hatchet [the common one, 1D6 + 4, KK+13, BF 2, AT-2, PA-4] */
	ITEM_ID_ORKNASE                           = 0x88, /* orc nose */
	ITEM_ID_SCHNEIDZAHN                       = 0x89, /* cutting tooth */
	ITEM_ID_ROBBENTOETER                      = 0x8a, /* seal killer */
	ITEM_ID_WOLFSMESSER                       = 0x8b, /* wolf knive */
	ITEM_ID_HEXENBESEN                        = 0x8c, /* witches broom */
	ITEM_ID_LOTUSGIFT                         = 0x8d, /* Lotus poison */
	ITEM_ID_KUKRIS                            = 0x8e, /* Kukris */
	ITEM_ID_BANNSTAUB                         = 0x8f, /* Bannstaub */
	ITEM_ID_KROETENSCHEMELGIFT                = 0x90, /* Krötenschemel poison */
	ITEM_ID_HEILTRANK                         = 0x91, /* LE potion */
	ITEM_ID_STARKER_HEILTRANK                 = 0x92, /* strong LE potion */
	ITEM_ID_MU_ELIXIER                        = 0x93, /* MU Elixier */
	ITEM_ID_KL_ELIXIER                        = 0x94, /* KL Elixier */
	ITEM_ID_CH_ELIXIER                        = 0x95, /* CH Elixier */
	ITEM_ID_FF_ELIXIER                        = 0x96, /* FF Elixier */
	ITEM_ID_GE_ELIXIER                        = 0x97, /* GE Elixier */
	ITEM_ID_IN_ELIXIER                        = 0x98, /* IN Elixier */
	ITEM_ID_KK_ELIXIER                        = 0x99, /* KK Elixier */
	ITEM_ID_ZAUBERTRANK                       = 0x9a, /* AE potion */
	ITEM_ID_ZAUBERTRANK_STARK                 = 0x9b, /* strong AE potion */
	ITEM_ID_OLGINWURZEL                       = 0x9c, /* Olgin root */
	ITEM_ID_KAIRANHALM                        = 0x9d, /* Kairan stem */
	ITEM_ID_BASTARDSCHWERT__MAGIC             = 0x9e, /* bastard sword [magic: lower BF; found in Daspota] */
	ITEM_ID_ORKNASE__MAGIC                    = 0x9f, /* orc nose [magic: damage +5, AT-1, PA-5; found in Daspota] */
	ITEM_ID_KURZSCHWERT__MAGIC                = 0xa0, /* short sword [magic: AT + 2, unbreakable; found in Daspota ] */
	ITEM_ID_SICHEL__MAGIC                     = 0xa1, /* sickle [magic, while in inventory: Pflanzenkunde + 3; found in Daspota] */
	ITEM_ID_AMULETT__ANTI_IGNIFAXIUS          = 0xa2, /* amulet [6 blue gems; found at a corpse in tevent014]. Analues: "Dient der Abwehr von Ignifaxius". apparently, no effect is implemented. */
	ITEM_ID_AMULETT__MR_BONUS                 = 0xa3, /* amulet [yellow star, magic: while in inventory MR + 5; found in FIGHT_ID_F100_13 in DUNGEON_ID_RUINE_DES_SCHWARZMAGIERS and ruin of the black wizard and at FIGHT_ID_F035 on the route Phexcaer <-> Einsiedlersee] */
	ITEM_ID_KNOCHEN_MIT_RUNE                  = 0xa4, /* bone with rune [found in Gorah's chest] */
	ITEM_ID_RING__RED                         = 0xa5, /* ring [red, magic, MR + 2. additionally 5 charges of Arcano Psychostabilis (additionally MR + 2) when used; found in Gorah's chest ] */
	ITEM_ID_EXPURGICUM                        = 0xa6, /* Expurgicum */
	ITEM_ID_REZEPT_FUER_EXPURGICUM            = 0xa7, /* recipe for Expurgicum */
	ITEM_ID_VOMICUM                           = 0xa8, /* Vomicum */
	ITEM_ID_REZEPT_FUER_VOMICUM               = 0xa9, /* recipe for Vomicum */
	ITEM_ID_DOKUMENT__UNICORN                 = 0xaa, /* unicorn letter [found in tevent073] */
	ITEM_ID_SILBERNER_STIRNREIF__1            = 0xab, /* silver coronet [magic, 3 charges, use -> Armatrutz +5, i.e. RS + 5] */
	ITEM_ID_SAEBEL__MAGIC                     = 0xac, /* sabre [magic, damage+1 to skeletons and zombies] */
	ITEM_ID_AMULETT__FEUERBANN                = 0xad, /* amulet [6 blue gems, magic, protection from fire; found at a corpse between Rovamund and Nordvest. Is there another one on the Totenschiff? ] */
	ITEM_ID_AMULETT__FLIM_FLAM                = 0xae, /* amulet [6 blue gems, magic, 6 charges: use -> Flim Flam; found in Totenschiff.] */
	ITEM_ID_AMULETT__TRAVIA                   = 0xaf, /* amulet [golden cross, magic: no hunger or thirst; found in Wolfshoehle ] */
	ITEM_ID_SCHULDBUCH                        = 0xb0, /* debt register [found in Wolfshoehle] */
	ITEM_ID_ROTE_MONDSCHEIBE                  = 0xb1, /* red moon disk [found in Orkhoehle; red herring] */
	ITEM_ID_ZWEIHAENDER__MAGIC                = 0xb2, /* two-handed sword [magic: unbreakable; found in Orkhoehle] */
	ITEM_ID_ORKDOKUMENT                       = 0xb3, /* orc document [found in Orkhoehle] */
	ITEM_ID_GEGENGIFT                         = 0xb4, /* antivenom */
	ITEM_ID_GRIMRING                          = 0xb5, /* Grimring [found at Hyggelik's ruin] */
	ITEM_ID_TOTENKOPFGUERTEL                  = 0xb6, /* skull belt [magic: TA - 4; found in Verfallene Herberge ] */
	ITEM_ID_KRAFTGUERTEL                      = 0xb7, /* girdle of might [magic: KK + 5; found in Drachenhoehle] */
	ITEM_ID_MAGISCHER_BROTBEUTEL              = 0xb8, /* magic breadbag [cannot be found in the game] */
	ITEM_ID_MAGISCHER_WASSERSCHLAUCH          = 0xb9, /* magic waterskin [cannot be found in the game] */
	ITEM_ID_REZEPT_FUER_HEILTRANK             = 0xba, /* recipe for heal potion */
	ITEM_ID_SCHREIBEN_VON_JADRA               = 0xbb, /* writing of Jarda */
	ITEM_ID_AMULETT__ORDINARY                 = 0xbc, /* amulet [golden cross. not magic. found in fight F094_02 in DUNGEON_ID_DASPOTASCHATZ ] */
	ITEM_ID_LOBPREISUNGEN                     = 0xbd, /* praises of the nameless god [found in Tempel des Namenlosen and in Piratenhoehle] */
	ITEM_ID_MITGLIEDERLISTE                   = 0xbe, /* member list [found in Tempel des Namenlosen] */
	ITEM_ID_DOKUMENT__2                       = 0xbf, /* document [2, not readable. Depotschein?] */
	ITEM_ID_SEEKARTE                          = 0xc0, /* sea chart [found in Piratenhoehle] */
	ITEM_ID_KUKRISDOLCH                       = 0xc1, /* Kukris dagger */
	ITEM_ID_SCHLUESSEL__YELLOW                = 0xc2, /* key [yellow] */ /* Found in FIGHT_ID_DTHO21A, FIGHT_ID_DTHO21B, FIGHT_ID_DTH021A in DUNGEON_ID_ZWINGFESTE */
	ITEM_ID_GOLDENER_SCHLUESSEL               = 0xc3, /* golden key [found in the dungeon of the Daspota treasure] / note that there is also ITEM_ID_GOLDSCHLUESSEL */
	ITEM_ID_HELM__CURSED                      = 0xc4, /* helmet [cursed: CH - 1; found in goblin cave and at NPC Ardora von Greifenfurt ] */
	ITEM_ID_KETTENHEMD__CURSED                = 0xc5, /* chain mail [magic, cursed, protection +1 vs. skeletons and zombies (arising as damage-3, but protection-2), but protection -2 vs. everything else, additionally drains LE; found in Drachenhoehle] */
	ITEM_ID_KETTENHEMD__MAGIC                 = 0xc6, /* chain mail [magic, AT+1, BE-1, RS+1; found in the dungeon of the Daspota treasure (Rybon-Thoss)] */
	ITEM_ID_SCHWERT__MAGIC                    = 0xc7, /* sword [magic: AT + 2; found in Drachenhoehle] */
	ITEM_ID_KUKRIS_MENGBILAR                  = 0xc8, /* Kukris mengbilar */
	ITEM_ID_PLATINSCHLUESSEL                  = 0xc9, /* platin key */ /* found in FIGHT_ID_F129_29 in DUNGEON_ID_DRACHENHORT */
	ITEM_ID_REZEPT_FUER_GEGENGIFT             = 0xca, /* recipe for antivenom */
	ITEM_ID_REZEPT_FUER_HYLAILER_FEUER        = 0xcb, /* recipe for Hylailer Feuer */
	ITEM_ID_REZEPT_FUER_KRAFTELIXIER          = 0xcc, /* recipe for KK elixir */
	ITEM_ID_REZEPT_FUER_MUTELIXIER            = 0xcd, /* recipe for MU elixir */
	ITEM_ID_REZEPT_FUER_ZAUBERTRANK           = 0xce, /* recipe for AE potion */
	ITEM_ID_RING__BLUE                        = 0xcf, /* ring [blue, not magic, found in Zwingfeste] */
	ITEM_ID_SCHLUESSEL__SILVER                = 0xd0, /* key [silver] */
	ITEM_ID_EISENSCHLUESSEL__1                = 0xd1, /* iron key [1] */ /* Found in FIGHT_ID_F131_10 in DUNGEON_ID_PIRATENHOEHLE */
	ITEM_ID_EISENSCHLUESSEL__2                = 0xd2, /* iron key [2] */ /* Found in FIGHT_ID_F131_14A and FIGHT_ID_F131_14B in DUNGEON_ID_PIRATENHOEHLE */
	ITEM_ID_ROTER_SCHLUESSEL                  = 0xd3, /* red key */ /* found in FIGHT_ID_F126_28 in DUNGEON_ID_KULTSTAETTE_DES_NAMENLOSEN */
	ITEM_ID_BRONZESCHLUESSEL                  = 0xd4, /* bronze key [red] */ /* found in FIGHT_ID_F108_9 in DUNGEON_ID_ORKBEHAUSUNG */
	ITEM_ID_SILBERHELM                        = 0xd5, /* silver helmet [magic: can be worn by all hero classes; found in Wolfshoehle] */
	ITEM_ID_SILBERSTREITKOLBEN                = 0xd6, /* silver mace [magic; found in Verfallene Herberge] */
	ITEM_ID_SILBERSCHMUCK__MAGIC              = 0xd7, /* silver jewelry [magic: TA - 2; found in Verfallene Herberge] */
	ITEM_ID_SPEER__MAGIC                      = 0xd8, /* spear [magic; found in Spinnenhoehle] */
	ITEM_ID_STIRNREIF__MR_BONUS               = 0xd9, /* coronet [magic: MR + 2; found in Tempel des Namenlosen] */
	ITEM_ID_WURFDOLCH__MAGIC                  = 0xda, /* throwing dagger [magic, improved accuracy, damage 1D6 + 9; found in Drachenhoehle]. Note that there is no 'ordinary' throwing dagger in the game. See the discussion at https://crystals-dsa-foren.de/showthread.php?pid=170046 */
	ITEM_ID_GOLDSCHLUESSEL                    = 0xdb, /* gold key. note that there is also ITEM_ID_GOLDENER_SCHLUESSEL (golden key) */
	ITEM_ID_RING__GREEN                       = 0xdc, /* ring [green, magic: protection from magic fire; found in Drachenhoehle] */
	ITEM_ID_BEUTEL                            = 0xdd, /* bag [found and used in the first level of the ruin of the black wizard to open a passage] */
	ITEM_ID_BUCH__PIRATE_ACCOUNTING           = 0xde, /* book [dacades old accounting book about loot income of Daspota pirates] */
	ITEM_ID_ANTIKRANKHEITSELIXIER             = 0xdf, /* anti disease elixir */
	ITEM_ID_BUCH__KAISERSPRUECHE_HALS         = 0xe0, /* book ["Kaisersprüche Hals"; found in the dungeon of the Daspota treasure (Rybon-Thoss)] */
	ITEM_ID_KRISTALL                          = 0xe1, /* crystal */
	ITEM_ID_MU_ELIXIER__BAD                   = 0xe2, /* MU elixir [bad] */
	ITEM_ID_KL_ELIXIER__BAD                   = 0xe3, /* KL elixir [bad] */
	ITEM_ID_CH_ELIXIER__BAD                   = 0xe4, /* CH elixir [bad] */
	ITEM_ID_FF_ELIXIER__BAD                   = 0xe5, /* FF elixir [bad] */
	ITEM_ID_GE_ELIXIER__BAD                   = 0xe6, /* GE elixir [bad] */
	ITEM_ID_IN_ELIXIER__BAD                   = 0xe7, /* IN elixir [bad] */
	ITEM_ID_KK_ELIXIER__BAD                   = 0xe8, /* KK elixir [bad] */
	ITEM_ID_ROBE__GREEN_2                     = 0xe9, /* robe [green] */
	ITEM_ID_GOLDENER_SCHILD                   = 0xea, /* golden shield [magic: can be equiped by all hero classes; found in Tempel des Namenlosen ] */
	ITEM_ID_EMPFEHLUNGSSCHREIBEN__HETMAN      = 0xeb, /* commendation letter [Hetman] */
	ITEM_ID_WUNDERKUR                         = 0xec, /* Wunderkur */
	ITEM_ID_SCHLAFTRUNK                       = 0xed, /* sleep potion */
	ITEM_ID_MIASTHMATICUM                     = 0xee, /* Miasthmaticum */
	ITEM_ID_HYLAILER_FEUER                    = 0xef, /* Hylailer Feuer */
	ITEM_ID_REZEPT_FUER_STARKEN_HEILTRANK     = 0xf0, /* recipe for strong LE potion [given by Olimone, tevent_114 Phexcaer <-> Skelellen: a swamp ]*/
	ITEM_ID_REZEPT_FUER_WUNDERKUR             = 0xf1, /* recipe for Wunderkur */
	ITEM_ID_REZEPT_FUER_SCHLAFTRUNK           = 0xf2, /* recipe for sleeping potion */
	ITEM_ID_REZEPT_FUER_STARKER_ZAUBERTRANK   = 0xf3, /* recipe for strong AE potion */
	ITEM_ID_REZEPT_FUER_MIASTHMATICUM         = 0xf4, /* recipe for Miasthmaticum */
	ITEM_ID_SILBERNER_STIRNREIF__2            = 0xf5, /* silver coronet [magic, 3 charges: use -> Armatrutz +5, i.e. RS + 5; found 2x in a chest in DUNGEON_ID_SPINNENHOEHLE ] */
	ITEM_ID_BUCH__HEPTAGON                    = 0xf6, /* book [read -> 'Heptagon' spell +3; found in Spinnenhoehle] */
	ITEM_ID_EMPFEHLUNGSSCHREIBEN__SIEBENSTEIN = 0xf7, /* commendation letter [Umbrik Siebenstein] */
	ITEM_ID_SCHWARZE_STATUETTE                = 0xf8, /* black figurine, found in Tempel des Namenlosen and used as evidence to Eliane Windenbeck */
	ITEM_ID_LATERNE__LIT                      = 0xf9, /* lantern [lit] */
	ITEM_ID_DUKATEN                           = 0xfa, /* ducats */
	ITEM_ID_200_PFEILE                        = 0xfb, /* 200 arrows */
	ITEM_ID_50_BOLZEN                         = 0xfc, /* 50 bolts */
	ITEM_ID_20_KLETTERHAKEN                   = 0xfd  /* 20 climbing hooks */
};
