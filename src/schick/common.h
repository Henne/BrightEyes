...
enum {
	...
	ITEM_PRAIOS_AMULETT			= 0x5e, /* Praios amulet [magic; found in spider cave] */
	...
	ITEM_AMULETT__UNKNOWN_1			= 0xa2, /* amulet [TODO: which one?? it might be yellow, magic: protects from fire; found at Totenschiff] */
	...
	ITEM_RING__RED				= 0xa5, /* ring [red, magic, MR + 2, additionally 5 charges of Arcano Psychostabilis (additionally MR + 2) when used; found at Gorah ] */
	...
	ITEM_DOKUMENT__1			= 0xaa, /* document [1, Depotschein?] */
	...
	ITEM_TRAVIA_AMULETT			= 0xaf, /* amulet [golden cross, magic: no hunger or thirst; found in wolf cave ] */
	ITEM_SCHULDBUCH				= 0xb0, /* debt register */
	ITEM_ROTE_MONDSCHEIBE			= 0xb1, /* red moon disk [found in orc cave] */
	ITEM_ZWEIHAENDER__MAGIC			= 0xb2, /* two-handed sword [magic: unbreakable; found in orc cave] */
	ITEM_ORKDOKUMENT			= 0xb3, /* orc document */
	...
	ITEM_KRAFTGUERTEL			= 0xb7, /* girdle of might [magic: KK + 5; found in dragon cave] */
	...
	ITEM_LOBPREISUNGEN			= 0xbd, /* praises */
	ITEM_MITGLIEDERLISTE			= 0xbe, /* member list */
	ITEM_DOKUMENT__2			= 0xbf, /* document [2] */
	ITEM_SEEKARTE				= 0xc0, /* sea chart */
	...
	ITEM_KETTENHEMD__CURSED			= 0xc5, /* chain mail [magic, cursed, protection +1 vs. skeletons and zombies, but protection -2 vs. everything else, additionally drains LE; found in dragon cave] */
	ITEM_KETTENHEMD__MAGIC			= 0xc6, /* chain mail [magic, AT+1, BE-1, RS+1; found in the dungeon of the Daspota treasure (Rybon-Thoss)] */
	ITEM_SCHWERT__MAGIC			= 0xc7, /* sword [magic: AT + 2; found in dragon cave] */
	...
	ITEM_SILBERHELM				= 0xd5, /* silver helmet [magic: can be worn by all hero classes; found in wolf cave] */
	...
	ITEM_SPEER__MAGIC			= 0xd8, /* spear [magic; found in spider cave] */
	ITEM_STIRNREIF__BLUE			= 0xd9, /* coronet [blau, magic: MR + 2; found in Tempel des Namenlosen] */
	ITEM_WURFDOLCH__MAGIC			= 0xda, /* throwing dagger [magic; found in dragon cave]. note that there is no 'ordinary' throwing dagger in the game */
	ITEM_GOLDSCHLUESSEL			= 0xdb, /* gold key. note that there is also ITEM_GOLDENER_SCHLUESSEL (golden key) */
	ITEM_RING__GREEN			= 0xdc, /* ring [green, magic: protection from magic fire; found in dragon cave] */
	...
	ITEM_STIRNREIF__GREEN			= 0xf5, /* coronet [green, magic: use -> Armatrutz +5, i.e. RS + 5; found 2x in spider cave] */
	ITEM_BUCH__HEPTAGON			= 0xf6, /* book [read -> 'Heptagon' spell +3; found in spider cave] */
