...
void tevent_016(void)
{
	...
	if (!ds_readb(TEVENT016_FLAG))
	{
		...
		do {
			answer = GUI_dialogbox((Bit8u*)ds_readd(DTP2), NULL, get_tx2(19), 2,
						get_tx2(20),
						get_tx2(21));
		} while (answer == -1);
		...
		if (answer == 1)
		{
			...
			do {
				answer = GUI_dialogbox((Bit8u*)ds_readd(DTP2), NULL, get_tx2(23), 2,
							get_tx2(24),
							get_tx2(25));
			} while (answer == -1);
			...
			if (answer == 1)
			{
				...
				do {
					answer = GUI_dialogbox((Bit8u*)ds_readd(DTP2), NULL, get_tx2(27), 2,
								get_tx2(28),
								get_tx2(29));
				} while (answer == -1);
...
void tevent_094(void)
{
	if (ds_readb(TEVENT094_FLAG) != 0)
	{
		...
		do {
			answer = GUI_dialogbox((Bit8u*)ds_readd(DTP2), NULL, get_tx2(4), 2,
						get_tx2(5),
						get_tx2(6));
		} while (answer == -1);
