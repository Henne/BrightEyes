...
//static
Bit8u* FIG_name_3rd_case(unsigned short, volatile unsigned short);
//static
Bit8u* FIG_name_4th_case(unsigned short, volatile unsigned short);
//static
Bit8u* FIG_name_1st_case(unsigned short, volatile unsigned short);
//static
